        ...
        <ScrollView>
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.actionContainer}>
                    <TouchableOpacity style={styles.actionBtn} onPress={() => navigation.navigate('HelpScreen')}>
                    ...
                    <TouchableOpacity style={styles.actionBtn} onPress={() => navigation.navigate('AboutUsScreen')}>
                        <View style={styles.actionInfo}>
